...
describe('Objects', () => {
  ...
  describe('Object Copying & Property Manipulation', () => {
  ...
  describe('Object Methods & Context', () => {
  ...
  describe('Advanced Object Patterns', () => {
  ...
  describe('Functional Programming with Objects', () => {
